/*
 * File:   WidthReductionOperation2.hpp
 *
...
#ifndef HTD_HTD_WIDTHREDUCTIONOPERATION2_HPP
#define HTD_HTD_WIDTHREDUCTIONOPERATION2_HPP
...
namespace htd
{
     ...
     *  by the bags.
     */
    class WidthReductionOperation2 : public virtual htd::ITreeDecompositionManipulationOperation
    {
        public:
            /**
             *  Constructor for a new manipulation operation of type WidthReductionOperation2.
             *
             *  @param[in] manager  The management instance to which the new manipulation operation belongs.
             */
            HTD_API WidthReductionOperation2(const htd::LibraryInstance * const manager);
            ...
            HTD_API WidthReductionOperation2 * clone(void) const HTD_OVERRIDE;
#else
            /**
             *  Create a deep copy of the current decomposition manipulation operation.
             *
             *  @return A new WidthReductionOperation2 object identical to the current decomposition manipulation operation.
             */
            HTD_API WidthReductionOperation2 * clone(void) const;
...
#endif /* HTD_HTD_WIDTHREDUCTIONOPERATION2_HPP */
