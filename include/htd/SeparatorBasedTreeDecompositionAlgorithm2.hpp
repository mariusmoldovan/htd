/*
 * File:   SeparatorBasedTreeDecompositionAlgorithm2.hpp
 *
...
#ifndef HTD_HTD_SEPARATORBASEDTREEDECOMPOSITIONALGORITHM2_HPP
#define HTD_HTD_SEPARATORBASEDTREEDECOMPOSITIONALGORITHM2_HPP
...
namespace htd
{
     ...
     */
    class SeparatorBasedTreeDecompositionAlgorithm2 : public htd::ITreeDecompositionAlgorithm
    {
        public:
            /**
             ...
             */
            HTD_API SeparatorBasedTreeDecompositionAlgorithm2(const htd::LibraryInstance * const manager, std::size_t maxWidth, std::size_t sepIter);
             ...
             */
            HTD_API SeparatorBasedTreeDecompositionAlgorithm2(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, std::size_t maxWidth, std::size_t sepIter);

            /**
             *  Copy constructor for a htd::SeparatorBasedTreeDecompositionAlgorithm2 object.
             *
             *  @param[in] original The original htd::SeparatorBasedTreeDecompositionAlgorithm2 object.
             */
            HTD_API SeparatorBasedTreeDecompositionAlgorithm2(const htd::SeparatorBasedTreeDecompositionAlgorithm2 & original);

            HTD_API virtual ~SeparatorBasedTreeDecompositionAlgorithm2();
            ...
            HTD_API SeparatorBasedTreeDecompositionAlgorithm2 * clone(void) const HTD_OVERRIDE;
        ...
        protected:
             ...
             */
            SeparatorBasedTreeDecompositionAlgorithm2 & operator=(const SeparatorBasedTreeDecompositionAlgorithm2 &) { return *this; }
...
#endif /* HTD_HTD_SEPARATORBASEDTREEDECOMPOSITIONALGORITHM2_HPP */
