/*
 * File:   WidthReductionOperation2.cpp
 *
...
#ifndef HTD_HTD_WIDTHREDUCTIONOPERATION2_CPP
#define HTD_HTD_WIDTHREDUCTIONOPERATION2_CPP
...
/**
 *  Private implementation details of class htd::WidthReductionOperation2.
 */
struct htd::WidthReductionOperation2::Implementation
{
    /**
...
htd::WidthReductionOperation2::WidthReductionOperation2(const htd::LibraryInstance * const manager) : implementation_(new Implementation(manager))
{

}

htd::WidthReductionOperation2::~WidthReductionOperation2()
{

}

void htd::WidthReductionOperation2::apply(const htd::IMultiHypergraph & graph, htd::IMutableTreeDecomposition & decomposition) const
{
    apply(graph, decomposition, std::vector<htd::ILabelingFunction *>());
}

void htd::WidthReductionOperation2::apply(const htd::IMultiHypergraph & graph, htd::IMutableTreeDecomposition & decomposition, const std::vector<htd::vertex_t> & relevantVertices, std::vector<htd::vertex_t> & createdVertices, std::vector<htd::vertex_t> & removedVertices) const
{
    apply(graph, decomposition, relevantVertices, std::vector<htd::ILabelingFunction *>(), createdVertices, removedVertices);
}

void htd::WidthReductionOperation2::apply(const htd::IMultiHypergraph & graph, htd::IMutableTreeDecomposition & decomposition, const std::vector<htd::ILabelingFunction *> & labelingFunctions) const
{
...
void htd::WidthReductionOperation2::apply(const htd::IMultiHypergraph & graph, htd::IMutableTreeDecomposition & decomposition, const std::vector<htd::vertex_t> & relevantVertices, const std::vector<htd::ILabelingFunction *> & labelingFunctions, std::vector<htd::vertex_t> & createdVertices, std::vector<htd::vertex_t> & removedVertices) const
{
    ...
    while (ok && currentIteration <= maxIterations)
    {
        ok = false;
...
bool htd::WidthReductionOperation2::isLocalOperation(void) const
{
    return false;
}

bool htd::WidthReductionOperation2::createsTreeNodes(void) const
{
    return true;
}

bool htd::WidthReductionOperation2::removesTreeNodes(void) const
{
    return true;
}

bool htd::WidthReductionOperation2::modifiesBagContents(void) const
{
    return true;
}

bool htd::WidthReductionOperation2::createsSubsetMaximalBags(void) const
{
    return true;
}

bool htd::WidthReductionOperation2::createsLocationDependendLabels(void) const
{
    return false;
}

const htd::LibraryInstance * htd::WidthReductionOperation2::managementInstance(void) const HTD_NOEXCEPT
{
    return implementation_->managementInstance_;
}

void htd::WidthReductionOperation2::setManagementInstance(const htd::LibraryInstance * const manager)
{
...
bool htd::WidthReductionOperation2::isRestrictedToLargestBags(void) const
{
    return implementation_->restrictedToLargestBags_;
}

void htd::WidthReductionOperation2::setRestrictedToLargestBags(bool restrictedToLargestBags)
{
...
{
    return new htd::WidthReductionOperation2(implementation_->managementInstance_);
}
...
htd::IDecompositionManipulationOperation * htd::WidthReductionOperation2::cloneDecompositionManipulationOperation(void) const
{
    return clone();
}

htd::ITreeDecompositionManipulationOperation * htd::WidthReductionOperation2::cloneTreeDecompositionManipulationOperation(void) const
{
    return clone();
}
#endif

bool htd::WidthReductionOperation2::Implementation::processDecompositionNode(const htd::IMultiHypergraph & graph, htd::IMutableTreeDecomposition & decomposition, htd::vertex_t vertex, std::vector<htd::vertex_t> & createdVertices, std::vector<htd::vertex_t> & removedVertices) const
{
    ...
    htd::WidthReductionOperation2::Implementation::InducedGraph * inducedGraph = createCorrespondingGraph(graph, decomposition, vertex);
...
bool htd::WidthReductionOperation2::Implementation::isComplete(const htd::IGraphStructure & graph) const
{
    bool ret = true;
...
bool htd::WidthReductionOperation2::Implementation::isInSubtree(const htd::ITreeDecomposition & decomposition, htd::vertex_t root, htd::vertex_t vertex) const
{
...
htd::WidthReductionOperation2::Implementation::InducedGraph * htd::WidthReductionOperation2::Implementation::createCorrespondingGraph(const htd::IMultiHypergraph & graph, const htd::ITreeDecomposition & decomposition, htd::vertex_t vertex) const
{
    HTD_ASSERT(decomposition.isVertex(vertex))

    const std::vector<htd::vertex_t> & bagContent = decomposition.bagContent(vertex);

    htd::WidthReductionOperation2::Implementation::InducedGraph * ret = new htd::WidthReductionOperation2::Implementation::InducedGraph(graph, bagContent);
...
#endif /* HTD_HTD_WIDTHREDUCTIONOPERATION2_CPP */
